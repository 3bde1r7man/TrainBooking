...
class GUI:
    ...
    def add_trip(self):
        addTripWin = tk.Tk()
        addTripWin.title("Trip")
        lbl_trip_src = tk.Label(addTripWin, text="Source:")
        lbl_trip_src.pack()

        trip_src = tk.Entry(addTripWin)
        trip_src.pack()

        lbl_trip_dest = tk.Label(addTripWin, text="Destination:")
        lbl_trip_dest.pack()

        trip_dest = tk.Entry(addTripWin)
        trip_dest.pack()

        lbl_trip_departs = tk.Label(addTripWin, text="Departs:")
        lbl_trip_departs.pack()

        trip_departs = tk.Entry(addTripWin)
        trip_departs.pack()

        lbl_trip_arrives = tk.Label(addTripWin, text="Arrives:")
        lbl_trip_arrives.pack()

        trip_arrives = tk.Entry(addTripWin)
        trip_arrives.pack()

        lbl_trip_price = tk.Label(addTripWin, text="Price:")
        lbl_trip_price.pack()

        trip_price = tk.Entry(addTripWin)
        trip_price.pack()

        add_trip_btn = tk.Button(addTripWin, text="Add Trip", command=lambda:self.admin.add_trip(trip_src.get(), trip_dest.get(), trip_departs.get(), trip_arrives.get(), trip_price.get()))
        add_trip_btn.pack()
    ...
    def update_trip(self):
        updataTripWin = tk.Tk()
        updataTripWin.title("Trip")

        lbl_trip_id = tk.Label(updataTripWin, text="ID:")
        lbl_trip_id.pack()

        trip_id = tk.Entry(updataTripWin)
        trip_id.pack()

        lbl_trip_src = tk.Label(updataTripWin, text="Source:")
        lbl_trip_src.pack()

        trip_src = tk.Entry(updataTripWin)
        trip_src.pack()

        lbl_trip_dest = tk.Label(updataTripWin, text="Destination:")
        lbl_trip_dest.pack()

        trip_dest = tk.Entry(updataTripWin)
        trip_dest.pack()

        lbl_trip_departs = tk.Label(updataTripWin, text="Departs:")
        lbl_trip_departs.pack()

        trip_departs = tk.Entry(updataTripWin)
        trip_departs.pack()

        lbl_trip_arrives = tk.Label(updataTripWin, text="Arrives:")
        lbl_trip_arrives.pack()

        trip_arrives = tk.Entry(updataTripWin)
        trip_arrives.pack()

        lbl_trip_price = tk.Label(updataTripWin, text="Price:")
        lbl_trip_price.pack()

        trip_price = tk.Entry(updataTripWin)
        trip_price.pack()

        add_trip_btn = tk.Button(updataTripWin, text="Update Trip", command=lambda:self.admin.update_trip(trip_id.get(), trip_src.get(), trip_dest.get(), trip_departs.get(), trip_arrives.get(), trip_price.get()))
        add_trip_btn.pack()
